...
import { dark_grey } from '../../public/colors';
  ...
  return (
    <div style={{ padding: '15vh 15vw' }}>
      {/* <Article2_EN
        ...
        bodyTextColor={dark_grey}
        bulletListHeadingColor={dark_grey}
        articleTitle="PRIVACY NOTICE (July 13, 2022)"
      ...
      <p>
        Michael Aziz Ibrahim built the Be Happy app as a Free app. This SERVICE
        is provided by Michael Aziz Ibrahim at no cost and is intended for use
        as is.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Be Happy unless otherwise
      ...
      <p>
        ...
        hesitate to contact me at michael.aziz@alnour-assoc.com.
      </p>{' '}
      <p>
