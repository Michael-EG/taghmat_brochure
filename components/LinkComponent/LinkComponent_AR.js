...
export default function LinkComponent_AR(
  {
    imageURL,
    imageAltText,
    title,
  ...
  if (largeView) {
    return (
      <div className='link-component-main-div' style={{ background: sectionBackgroundColor }}>
        <div className='link-component-card-content-main-div_2-ar' >
          <div className='link-component-card-content-action-button-area_2-ar'>
          ...
          <div className='link-component-card-content-text-area_2-ar'>
